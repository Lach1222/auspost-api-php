...
class ServiceCode extends Enum
{
    ...
    const AUS_PARCEL_REGULAR_SATCHEL_1KG = 'AUS_PARCEL_REGULAR_SATCHEL_1KG';
    ...
    const AUS_PARCEL_EXPRESS_SATCHEL_1KG = 'AUS_PARCEL_EXPRESS_SATCHEL_1KG';
    ...
    const INT_PARCEL_STD_SMALL_SATCHEL = 'INT_PARCEL_STD_SMALL_SATCHEL';

    const INT_PARCEL_STD_MEDIUM_SATCHEL = 'INT_PARCEL_STD_MEDIUM_SATCHEL';

    const INT_PARCEL_STD_LARGE_SATCHEL = 'INT_PARCEL_STD_LARGE_SATCHEL';
